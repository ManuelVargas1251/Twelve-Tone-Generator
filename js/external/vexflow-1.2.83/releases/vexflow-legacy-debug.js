...
/***/ function(module, exports, __webpack_require__) {
	...
	var Renderer = exports.Renderer = function () {
	  Renderer.buildContext = function buildContext(sel, backend, width, height, background) {
	  ...
	  Renderer.getCanvasContext = function getCanvasContext(sel, width, height, background) {
	    return Renderer.buildContext(sel, Renderer.Backends.CANVAS, width, height, background);
	  };
	
	  Renderer.getRaphaelContext = function getRaphaelContext(sel, width, height, background) {
	    return Renderer.buildContext(sel, Renderer.Backends.RAPHAEL, width, height, background);
	  };
	
	  Renderer.getSVGContext = function getSVGContext(sel, width, height, background) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stem = exports.Stem = function (_Element) {
	  ...
	  Stem.prototype.setStyle = function setStyle(style) {
	    this.style = style;return this;
	  };
	
	  Stem.prototype.getStyle = function getStyle() {
	    return this.style;
	  };
	  ...
	  Stem.prototype.applyStyle = function applyStyle(context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteHead = exports.NoteHead = function (_Note) {
	  ...
	  NoteHead.prototype.getStyle = function getStyle() {
	    return this.style;
	  };
	
	  NoteHead.prototype.setStyle = function setStyle(style) {
	    this.style = style;return this;
	  };
	  ...
	  NoteHead.prototype.applyStyle = function applyStyle(context) {
	    var style = this.getStyle();
	    if (style.shadowColor) context.setShadowColor(style.shadowColor);
	    if (style.shadowBlur) context.setShadowBlur(style.shadowBlur);
	  ...
	  Accidental.format = function format(accidentals, state) {
	    ...
	    var _loop = function _loop(_i3) {
	      ...
	      var lineDifference = function lineDifference(indexA, indexB) {
	        ...
	        var a = _getGroupLines$map[0];
	        var b = _getGroupLines$map[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StringNumber = exports.StringNumber = function (_Modifier) {
	  ...
	  StringNumber.prototype.getPosition = function getPosition() {
	    return this.position;
	  };
	
	  StringNumber.prototype.setPosition = function setPosition(position) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeSignature = exports.TimeSignature = function (_StaveModifier) {
	  ...
	  TimeSignature.prototype.parseTimeSpec = function parseTimeSpec(timeSpec) {
	    ...
	    var topDigits = _timeSpec$split$map[0];
	    var botDigits = _timeSpec$split$map[1];
